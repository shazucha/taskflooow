    ...
    <div className="px-4 pt-6">
      ...
      <div className="card-elevated mt-5 flex items-center gap-4 p-5">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="truncate text-base font-semibold">{me?.full_name}</h2>
      ...
      <Button variant="outline" className="mt-6 w-full gap-2 rounded-xl" disabled>
        <LogOut className="h-4 w-4" /> Odhlásiť (po napojení Supabase)
      </Button>
    </div>
  );
}
