-- Mesačné bonusy v rámci predplatného (per projekt + konkrétny mesiac).
-- Na rozdiel od project_recurring_works tieto NIE sú šablóna pre každý mesiac,
-- ale konkrétne položky pridané iba pre daný month_key ("YYYY-MM").
