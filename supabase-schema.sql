-- =====================================================================
-- TaskFlow — Supabase schema (run in Supabase SQL editor)
-- Tables: profiles, projects, project_members, tasks, task_comments
-- =====================================================================
...
create policy "Members can view tasks"
  ...
  using (project_id is null and (created_by = auth.uid() or assignee_id = auth.uid())
...
create policy "Members or assignee can update tasks"
...
create policy "Members can write comments"
...
create policy "Authors can delete own comments"
  on public.task_comments for delete to authenticated using (author_id = auth.uid());
